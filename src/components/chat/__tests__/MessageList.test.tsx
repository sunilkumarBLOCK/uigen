...
// Helper to create UIMessage with text content
...
test("MessageList renders assistant messages", () => {
  const messages: UIMessage[] = [
    assistantMsg("1", "I'll help you create a button component."),
  ];
...
test("MessageList shows content for assistant message with text parts", () => {
  const messages: UIMessage[] = [
    assistantMsg("1", "Generating your component..."),
  ];
...
test("MessageList handles empty parts with text parts", () => {
  const messages: UIMessage[] = [
    {
      id: "1",
      role: "assistant",
